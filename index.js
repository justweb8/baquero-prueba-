...
/* ── navegar disponible globalmente desde el inicio ── */
window.navegar = function(s,e){
  // La función real se define en línea ~507, esperar si no está lista
  if(window._navegarReal) return window._navegarReal(s,e);
  setTimeout(()=>window.navegar(s,e),100);
};
...
/* ── NAVEGACIÓN SIDEBAR ── */
/* La función navegar real está definida más abajo con todos los cargar*() */
